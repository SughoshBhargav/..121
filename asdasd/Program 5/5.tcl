...
$nodes(is) label "Sender"
$nodes(ms) label "Mobile Station"
$nodes(bs1) label "Base Station 1"
$nodes(bs2) label "Base Station 2"
$nodes(lp) label "Destination"
$nodes(is) color "Magenta"
...
proc cell_topo {} {
	...
	$ns duplex-link $nodes(bs2) $nodes(is) 3Mbps 15nodes(ms) DropTail
...
if {$flows > 0} {
	...
	set ftp2 [[set ftp2] attach-app FTP]
	$tcp2 set window_ 3
...
proc stop {} {
	...
	set a "out.tr"
	set GETRC "/home/jaideep/ns-allinone-2.35/ns-2.35/bin/getrc"
	set RAW2XG "/home/jaideep/ns-allinone-2.35/ns-2.35/bin/raw2xg"
